...
public class EditAssignmentActivity extends AppCompatActivity implements View.OnFocusChangeListener{
    ...
    private String TAG = "Edit Assignment";
    ...
    private void fetchData() {
        newAssignmentName.setText(assignment.getName());
        deadlineDate.setText(assignment.getDeadlineDate());
        deadlineTime.setText(assignment.getDeadlineTime().toString());
        if(assignment.getDescription() != null) description.setText(assignment.getDescription());
    }
    ...
    private void updateData() {
        ...
        cv.put(dbHelper.COLASSIGNMENTOF, assignment.getCourseID());
        ...
        db.update(dbHelper.TBLASSIGNMENT, cv, dbHelper.COLID + " = " + assignment.getId(), null);
        Log.i(TAG, "updated");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save) {
            updateData();
            Toast.makeText(this, newAssignmentName.getText().toString()+" "+R.string.updated, Toast.LENGTH_SHORT);
            finish();
        }
